...
export const JoinGroupIcon = ({ size = 24, color = "currentColor", ...props }) => (
 <svg 
  ...
  <g stroke="black" strokeWidth="0.5">
    <rect x="16.25" y="5.25" width="4.5" height="0.5" rx="0.25" fill="black" strokeWidth="0.2"/>
    <rect x="18.75" y="3.25" width="4.5" height="0.5" rx="0.25" transform="rotate(90 18.75 3.25)" fill="black" strokeWidth="0.2"/>
  </g>

  <g id="person1" className="person-shape">
    <circle cx="8" cy="8" r="2.5"/>
    <path d="M2.5 18 A 5 5.5 0 1 1 13.5 18 Z"/>
  </g>

  <g id="person2" className="person-shape">
...
<svg 
  ...
  {...props} 
>
  <path stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 4h3a2 2 0 0 1 2 2v1m-5 13h3a2 2 0 0 0 2-2v-1M4.425 19.428l6 1.8A2 2 0 0 0 13 19.312V4.688a2 2 0 0 0-2.575-1.916l-6 1.8A2 2 0 0 0 3 6.488v11.024a2 2 0 0 0 1.425 1.916zM9.001 12H9m7 0h5m0 0-2-2m2 2-2 2"/>
</svg>
);
